...
//Constructor al que se le pasan los ficheros a subir
    ...
    function __construct($nombre) {
        ...
        $this->destino = "files/"; //La carpeta en la que se almacenarán los ficheros subidos
        $this->maximo = 1024 * 1024 * 2; //Le doy 2MB te tamáño máximo de fichero
    ...
    public function subir() {
        ...
        for ($i = 0; $i < count($this->file['name']); $i++) {
            if ($this->nombre != "") { //comprobamos que el valor de es válido para obtener su pathinfo
                ...
                $n = pathinfo($this->destino . $this->file['name'][$i]); //en caso de que el nombre del fichero sea cadena vacía lo extraemos del array de files
            }
